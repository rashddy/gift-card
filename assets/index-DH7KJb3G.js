...
Your One & Only 💕`,DA="My Love";function __(){const[o,e]=Ke.useState([]);return Ke.useEffect(()=>{const r=setInterval(()=>{const l=Date.now()+Math.random(),c={id:l,left:Math.random()*100,animationDuration:3+Math.random()*4,size:12+Math.random()*16,opacity:.3+Math.random()*.4};e(h=>[...h,c]),setTimeout(()=>{e(h=>h.filter(d=>d.id!==l))},c.animationDuration*1e3)},800);return()=>clearInterval(r)},[]),ie.jsx("div",{className:"floating-hearts",children:o.map(i=>ie.jsx("span",{className:"floating-heart",style:{left:`${i.left}%`,animationDuration:`${i.animationDuration}s`,fontSize:`${i.size}px`,opacity:i.opacity},children:"💕"},i.id))})}function wA(){const[o,e]=Ke.useState(""),[i,r]=Ke.useState(!1),[l,c]=Ke.useState(""),[h,d]=Ke.useState(!1),[m,p]=Ke.useState(0),[x,_]=Ke.useState(!1),S=Ke.useRef(null);Ke.useEffect(()=>{const v=new Audio(AA);v.loop=!0,v.volume=.3,v.preload="auto",S.current=v,v.load(),(async()=>{try{await v.play(),_(!0)}catch{console.log("Autoplay blocked, waiting for user interaction")}})();const L=async()=>{if(!x&&S.current)try{await S.current.play(),_(!0)}catch{console.log("Could not play audio")}document.removeEventListener("click",L),document.removeEventListener("touchstart",L)};return document.addEventListener("click",L),document.addEventListener("touchstart",L),()=>{v.pause(),v.src="",document.removeEventListener("click",L),document.removeEventListener("touchstart",L)}},[]);const E=()=>{S.current&&(x?(S.current.pause(),_(!1)):(S.current.play(),_(!0)))},R=["Not quite , Some days become memories forever… try that one.💫","Almost there its really important to us ...I know your heart knows the way 🌸","That's not it, but don't give up on love...The key is a day that changed everything for us. 💝","The right code will reveal something special... 🌷","Keep believing... some treasures need patience 🦋"],C=v=>{v.preventDefault(),o.trim().toUpperCase()===RA.toUpperCase()?(r(!0),c("")):(d(!0),p(z=>z+1),c(R[m%R.length]),setTimeout(()=>d(!1),500))},M=v=>{e(v.target.value),l&&c("")};return i?ie.jsxs(ie.Fragment,{children:[ie.jsx(g_,{className:"snow-background",color:"#ffffff",variant:"square",flakeSize:.012,minFlakeSize:1.2,pixelResolution:150,speed:.5,density:.15,brightness:1.3,gamma:.5,depthFade:10,farPlane:15,style:{position:"fixed",inset:0,zIndex:0,pointerEvents:"none"}}),ie.jsx("button",{className:"music-toggle",onClick:E,"aria-label":"Toggle music",children:x?"🔊":"🔇"}),ie.jsxs("div",{className:"gift-card unlocked",children:[ie.jsx(__,{}),ie.jsxs("div",{className:"card-content",children:[ie.jsx("div",{className:"unlock-animation",children:ie.jsx("span",{className:"big-heart",children:"💝"})}),ie.jsxs("h1",{className:"recipient-name",children:["For ",DA]}),ie.jsxs("div",{className:"message-container",children:[ie.jsx("div",{className:"ribbon top-ribbon"}),ie.jsx("p",{className:"secret-message",children:CA}),ie.jsx("div",{className:"ribbon bottom-ribbon"})]}),ie.jsxs("div",{className:"decorative-footer",children:[ie.jsx("span",{children:"✨"}),ie.jsx("span",{children:"💕"}),ie.jsx("span",{children:"✨"})]})]})]})]}):ie.jsxs(ie.Fragment,{children:[ie.jsx(g_,{className:"snow-background",color:"#ffffff",variant:"square",flakeSize:.012,minFlakeSize:1.2,pixelResolution:150,speed:.5,density:.15,brightness:1.3,gamma:.5,depthFade:10,farPlane:15,style:{position:"fixed",inset:0,zIndex:0,pointerEvents:"none"}}),ie.jsx("button",{className:"music-toggle",onClick:E,"aria-label":"Toggle music",children:x?"🔊":"🔇"}),ie.jsxs("div",{className:"gift-card locked",children:[ie.jsx(__,{}),ie.jsxs("div",{className:"card-content",children:[ie.jsxs("div",{className:"gift-icon",children:[ie.jsx("span",{className:"gift-emoji",children:"🎁"}),ie.jsx("div",{className:"gift-glow"})]}),ie.jsx("h1",{className:"title",children:"A Special Gift Awaits"}),ie.jsx("p",{className:"subtitle",children:"Enter your secret code to unlock something magical..."}),ie.jsx("p",{className:"subtitle",children:"The key is a day that changed everything for us."}),ie.jsxs("form",{onSubmit:C,className:"code-form",children:[ie.jsxs("div",{className:`input-wrapper ${h?"shake":""}`,children:[ie.jsx("input",{type:"text",value:o,onChange:M,placeholder:"Enter gift code...",className:"code-input",autoComplete:"off",spellCheck:"false"}),ie.jsx("span",{className:"input-icon",children:"🔐"})]}),ie.jsxs("button",{type:"submit",className:"unlock-btn",children:[ie.jsx("span",{children:"Unlock My Gift"}),ie.jsx("span",{className:"btn-icon",children:"💌"})]})]}),l&&ie.jsx("p",{className:"error-message",children:l}),ie.jsx("p",{className:"hint-text",children:"Someone special has a message waiting just for you"})]})]})]})}fS.createRoot(document.getElementById("root")).render(ie.jsx(Ke.StrictMode,{children:ie.jsx(wA,{})}));
